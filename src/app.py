...
csv_file_dropdown = dcc.Dropdown(
    ...
    options=[
        {'label': 'Sparse Point', 'value': 'static/NG_mobile coverage (1).csv'},
        {'label': 'Point Generated by GPR ', 'value': 'static/Gussian_estimated_coverage_combined_filtered.csv'},
         {'label': 'Point Generated by  IDW', 'value': 'static/Idw_interpolated_data_filtered.csv'},
           {'label': 'Point Generated by SPLINE', 'value': 'static/Spline_combined_coverage_estimates_filtered.csv'},
...
def update_graph(selected_csv_file, network_type, longitude, latitude):
